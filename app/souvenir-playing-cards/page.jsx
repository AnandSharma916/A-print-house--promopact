...
import './souvenir-playing-cards.css';
import '../styles/inner-page-fixes.css';

export const metadata = {
  title: "Customised Playing Cards Manufacturer in India | A India Print House",
  description: "A India Print House is a trusted Customised Playing Cards Manufacturer in India. Beautifully designed customised playing cards for tourist destinations, museums, events, and gift shops — perfect for gifting, collecting, and promoting destinations or brands.",
  alternates: { canonical: "/souvenir-playing-cards" },
};
    ...
    <div className="page-root">
          ...
          <nav className={"hdr-nav"}>
            ...
            <div className={"hdr-dropdown"}>
              ...
              <div className={"hdr-menu"}>
                ...
                <Link href={"/souvenir-playing-cards"} className={"hdr-menu-link is-current"}>
      ...
      <section className={"hero"}>
        <div className={"hero__bg"}>
          <img alt={"Customised Playing Cards Hero"} src={"/img/souvenir-hero-bg-new.avif"} />
        ...
        <div className={"hero__content"}>
          ...
          <p className={"hero__text"}>
            Premium Customised Playing Cards by A India Print House — beautifully designed to showcase special places, cultures, landmarks, and memorable occasions.
          </p>
          <div>
        ...
        <div className={"container heritage__grid"}>
          <div className={"heritage__text"}>
            ...
            <p className={"body-md heritage__p"}>
              A India Print House is a trusted Customised Playing Cards Manufacturer in India, offering beautifully designed and customised playing cards for tourist destinations, museums, events, organizations, and gift shops. Our customised playing cards are a unique way to showcase special places, cultures, landmarks, and memorable occasions.
            </p>
          ...
          <div className={"heritage__media"}>
            <div className={"media-frame"}>
              <img alt={"YouTube Customised Playing Cards — A India Print House"} src={"/img/youtube-card-Photoroom.avif"} className={"youtube-media-img"} style={{ boxSizing: "border-box", objectPosition: "center" }} />
                ...
                <svg className={"badge__svg"} viewBox={"0 0 100 100"}>
                  ...
                  <text>
                    <textpath xlinkHref={"#textCirclePromo"}>
                      A INDIA PRINT HOUSE • SOUVENIR CARDS • SINCE 1998 •
                    </textpath>
                  </text>
                </svg>
        ...
        <div className={"container section--padded"}>
          <div className={"section-head"}>
            <h2 className={"headline-lg"} data-split="">
              High-Quality Customised Playing Cards
            </h2>
            <div className={"section-head__rule"} data-scroll="" data-scroll-class={"is-inview"}></div>
            <p className={"body-lg section-head__text"}>
              Our customised playing cards are designed to leave a lasting impression. Each deck can be customized with photographs, artwork, logos, historical information, or special themes that represent your brand or location.
            </p>
          </div>
                ...
                <div className={"atropos-rotate"}>
                  <div className={"atropos-inner"}>
                    <div className={"deck-card"}>
                      ...
                      <img className={"no-parallax"} alt={"Adobe Customised Playing Cards — A India Print House"} src={"/img/adobe-cards-souvenir-deckfit.avif"} />
              ...
              <div className={"atropos-scale"}>
                <div className={"atropos-rotate"}>
                  <div className={"atropos-inner"}>
                    <div className={"deck-card"}>
                      <div className={"deck-frame"} aria-hidden={"true"}></div>
                      <img className={"no-parallax"} alt={"CRED Customised Playing Cards — A India Print House"} src={"/img/cred-card-deckfit.avif"} />
                      <div className={"deck-card__caption"}>
                        <div>
                          <span className={"label-sm deck-card__kicker"}>
                            Vibrant Printing
      ...
      <section className={"card-showcase"} id={"card-showcase"}>
        <div className={"card-showcase__content container section--padded"}>
          ...
          <p className={"card-showcase__text"}>
            From landmarks to memories — every card in the deck tells a story, beautifully printed and built to be treasured.
          </p>
        </div>
      </section>
      {/* Features Bento Grid */}
          ...
          <div className={"bento"}>
            ...
            <div className={"bento__cell bento__cell--feature"}>
              <div>
                ...
                <p className={"body-md bento__desc"}>
                  Crafted from premium-grade card stock offering the perfect weight, feel, and durability — built to be used, gifted, and kept for years.
                </p>
              </div>
            ...
            <div className={"bento__cell"}>
              ...
              <h5 className={"label-md bento__heading"}>
                Creative & Colorful Printing
              </h5>
              <p className={"bento__desc bento__desc--sm"}>
                Vibrant, detailed artwork that captures places, culture, and moments beautifully.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Photographs, artwork, logos, landmarks, and historical themes — all tailored to you.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Multiple card sizes to suit your destination, event, or gifting requirements.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Scalable bulk production with custom packaging options for any order volume.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className={"apps__list"}>
              ...
              <li className={"apps__item"}>
                ...
                <span className={"headline-md apps__name"}>
                  Corporate Gifts &amp; Campaigns
                </span>
              </li>
            </ul>
          </div>
          <div className={"apps__media deck-card"}>
            <div className={"deck-frame"} aria-hidden={"true"}></div>
            <img alt={"PwC Advisory Vision 2030 Customised Playing Cards — A India Print House"} src={"/img/royal-stag-Photoroom.avif"} style={{ padding: "10%", boxSizing: "border-box", objectPosition: "center", objectFit: "contain" }} />
          </div>
        </div>
      </section>
      ...
      <section className={"section section--padded bg-surface"}>
        <div className={"container custom"}>
          <h2 className={"headline-lg custom__title"} data-split="">
            Benefits of Customised Playing Cards
          </h2>
          <p className={"body-lg custom__quote"}>
            "Customised playing cards are a creative keepsake that people can use and cherish for years. They help promote a destination, event, or brand while providing entertainment and lasting value to every customer who receives them."
          </p>
          <div className={"custom__sig"}>
            <div className={"custom__sig-rule"}></div>
            <span className={"label-md custom__sig-label"}>
              Souvenirs &amp; Keepsake Series
            </span>
          </div>
        </div>
      </section>
        ...
        <div className={"container why__grid"}>
          <div className={"why__quote"}>
            <blockquote className={"headline-lg"}>
              "Turn Memories into Beautiful Customised Playing Cards."
            </blockquote>
          </div>
            ...
            <div className={"why__benefits-grid"}>
              <div>
                ...
                <p className={"benefit__desc"}>
                  Elegant tuck boxes and custom gift sleeves that make every souvenir deck a ready-to-present keepsake — no extra wrapping needed.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                  Heritage-Grade Durability
                </h6>
                <p className={"benefit__desc"}>
                  Thick, moisture-resistant card stock ensures souvenirs survive years of handling, travel, and display without fading or warping.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                  Photo-Accurate Reproduction
                </h6>
                <p className={"benefit__desc"}>
                  Ultra-fine halftone printing faithfully reproduces landmark photography, paintings, and illustrations with gallery-level color fidelity.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                ...
                <p className={"benefit__desc"}>
                  Limited-edition numbering, foil highlights, and special finishes turn each deck into a collectible piece visitors genuinely want to keep.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className={"section bg-dark cta"}>
        ...
        <div className={"container section--padded"}>
          <h2 className={"display-lg cta__title"}>
            Create Souvenirs People Love to Keep
          </h2>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "18px", maxWidth: "640px", margin: "0 auto 48px", textAlign: "center", fontFamily: "var(--font-sans)" }}>
            Looking for a reliable Customised Playing Cards Manufacturer in India? A India Print House offers customised playing cards with premium quality printing and creative designs. A India Print House — Creating Souvenirs That People Love to Keep.
          </p>
        ...
        <div className={"footer-body container"}>
          <div className={"footer-top"}>
            <div className={"ft-brand-col"}>
              ...
              <p>
                India's trusted customised playing card manufacturer — creating keepsakes that people love to keep and share.
              </p>
            </div>
