...
export const metadata = {
  title: "Poker Cards Manufacturer in India | A India Print House",
  description: "A India Print House is a trusted Poker Cards Manufacturer in India. Premium quality poker cards for gaming, clubs, events, and promotional use — durable, smooth finish, clear printing, and custom design options.",
  alternates: { canonical: "/poker-cards" },
};
    ...
    <div className="page-root">
          ...
          <nav className={"hdr-nav"}>
            ...
            <div className={"hdr-dropdown"}>
              ...
              <div className={"hdr-menu"}>
                ...
                <Link href={"/poker-cards"} className={"hdr-menu-link is-current"}>
                  Poker Cards
                </Link>
      ...
      <section className={"hero"}>
        <div className={"hero__bg"}>
          <img alt={"Poker Cards Hero"} src={"/img/slider-bg-4.avif"} />
        ...
        <div className={"hero__content"}>
          ...
          <p className={"hero__text"}>
            Premium Quality Poker Cards by A India Print House — durable, smooth, and professionally finished for gaming, clubs, events, and promotional use.
          </p>
          <div>
        ...
        <div className={"container heritage__grid"}>
          <div className={"heritage__text"}>
            ...
            <h2 className={"headline-lg heritage__title"} data-split="">
              Premium Poker Cards for Every Game
            </h2>
            <p className={"body-md heritage__p"}>
              A India Print House is a trusted Poker Cards Manufacturer in India, offering high-quality printed poker cards for gaming, clubs, events, and promotional use. We design and manufacture durable poker cards that provide a smooth playing experience and long-lasting performance.
            </p>
          ...
          <div className={"heritage__media"}>
            <div className={"media-frame"}>
              <img alt={"Poker Cards Manufacturing"} src={"/img/poker-cards-Photoroom.avif"} style={{ padding: "4.16%", boxSizing: "border-box" }} />
                ...
                <svg className={"badge__svg"} viewBox={"0 0 100 100"}>
                  ...
                  <text>
                    <textpath xlinkHref={"#textCirclePromo"}>
                      A INDIA PRINT HOUSE • POKER CARDS • SINCE 1998 •
                    </textpath>
                  </text>
                </svg>
        ...
        <div className={"container section--padded"}>
          <div className={"section-head"}>
            ...
            <p className={"body-lg section-head__text"}>
              We focus on creating poker cards that are strong, easy to handle, and comfortable for repeated use. Our cards are suitable for both personal and commercial gaming purposes.
            </p>
          </div>
                ...
                <div className={"atropos-rotate"}>
                  <div className={"atropos-inner"}>
                    <div className={"deck-card"}>
                      ...
                      <img className={"no-parallax"} alt={"Swiggy Instamart Poker Night Cards — A India Print House"} src={"/img/poker-cards-ace-deckfit.avif"} />
              ...
              <div className={"atropos-scale"}>
                <div className={"atropos-rotate"}>
                  <div className={"atropos-inner"}>
                    <div className={"deck-card"}>
                      <div className={"deck-frame"} aria-hidden={"true"}></div>
                      <img className={"no-parallax"} alt={"PokerBaazi Poker Cards — A India Print House"} src={"/img/pokerbaazi-cards-deckfit.avif"} />
                      <div className={"deck-card__caption"}>
                        <div>
                          <span className={"label-sm deck-card__kicker"}>
                            Sharp Printing
      ...
      <section className={"card-showcase"} id={"card-showcase"}>
        <div className={"card-showcase__content container section--padded"}>
          ...
          <h2 className={"display-lg card-showcase__title"}>
            Perfect Cards for Perfect Gameplay
          </h2>
          <p className={"card-showcase__text"}>
            From the shuffle to the showdown — every card is built for smooth handling, sharp printing, and long-lasting play.
          </p>
        </div>
      </section>
      {/* Features Bento Grid */}
        ...
        <div className={"container"}>
          <div className={"specs__head"}>
            ...
            <h2 className={"headline-lg specs__title"} data-split="">
              Built for the Game, Made to Last
            </h2>
          </div>
          <div className={"bento"}>
            {/* Large Feature */}
            <div className={"bento__cell bento__cell--feature"}>
              <div>
                ...
                <p className={"body-md bento__desc"}>
                  Premium-grade card stock engineered for the perfect balance of snap, flex, and durability — designed to handle deal after deal without wear.
                </p>
              </div>
            ...
            <div className={"bento__cell"}>
              ...
              <h5 className={"label-md bento__heading"}>
                Clear & Sharp Printing
              </h5>
              <p className={"bento__desc bento__desc--sm"}>
                Razor-sharp suit symbols and pip values printed with vivid, consistent color every time.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Standard decks or fully custom-designed poker cards — tailored to your needs.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Available in standard poker size with packaging options for retail and gifting.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Scalable bulk production for clubs, casinos, tournaments, and retail distribution.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={"section section--padded bg-dark"}>
        <div className={"container apps__grid"}>
          ...
          <div className={"apps__media"} style={{ borderRadius: "0.25rem" }}>
            <img className={"no-parallax"} alt={"Poker Cards Applications Visual"} src={"/img/money-heist-cards-Photoroom-centred.avif"} style={{ transform: "scale(1.02)" }} />
      ...
      <section className={"section section--padded bg-surface"}>
        <div className={"container custom"}>
          <h2 className={"headline-lg custom__title"} data-split="">
            Benefits of Poker Cards
          </h2>
          <p className={"body-lg custom__quote"}>
            "Poker cards are designed for smooth gameplay and long use. They provide a professional gaming experience and can also be customized for branding and promotional purposes — making every hand a winning opportunity."
          </p>
          <div className={"custom__sig"}>
            <div className={"custom__sig-rule"}></div>
            <span className={"label-md custom__sig-label"}>
              Gaming &amp; Premium Cards Series
            </span>
          </div>
        </div>
      </section>
            ...
            <div className={"why__benefits-grid"}>
              <div>
                ...
                <p className={"benefit__desc"}>
                  Our poker cards are calibrated for the precise stiffness-to-flex ratio that allows single-card riffles, spring shuffles, and flourishes without fatigue.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                  Casino-Standard Indices
                </h6>
                <p className={"benefit__desc"}>
                  Wide-index and jumbo-index options ensure suits and ranks are instantly readable from all seating positions around any table size.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                  Cheat-Resistant Stock
                </h6>
                <p className={"benefit__desc"}>
                  Uniform ink density and opacity across every card prevents light-through marking — maintaining game integrity in competitive and casino play.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                ...
                <p className={"benefit__desc"}>
                  A low-sheen matte coat eliminates table-light reflections so players can read their hand clearly under any casino or home-game lighting.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className={"section bg-dark cta"}>
        ...
        <div className={"container section--padded"}>
          ...
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "18px", maxWidth: "640px", margin: "0 auto 48px", textAlign: "center", fontFamily: "var(--font-sans)" }}>
            Looking for a reliable Poker Cards Manufacturer in India? A India Print House provides premium-quality poker cards with excellent printing, strong material, and creative customization options. A India Print House — Your Trusted Partner for Premium Poker Cards.
          </p>
        ...
        <div className={"footer-body container"}>
          <div className={"footer-top"}>
            <div className={"ft-brand-col"}>
              ...
              <p>
                India's trusted poker cards manufacturer — premium quality, smooth finish, and perfect for every game.
              </p>
            </div>
