...
import './educational-cards.css';
import '../styles/inner-page-fixes.css';

export const metadata = {
  title: "Educational Cards Manufacturer in India | A India Print House",
  description: "A India Print House is a trusted Educational Cards Manufacturer in India. High-quality customized educational cards for schools, preschools, coaching centres, and publishers — designed for learning, memory building, and classroom engagement.",
  keywords: "educational cards manufacturer, educational cards printing India, custom learning cards, alphabet cards, number cards, school flash cards, educational card supplier Delhi",
  alternates: { canonical: "/educational-cards" },
};
    ...
    <div className="page-root">
          ...
          <nav className={"hdr-nav"}>
            ...
            <div className={"hdr-dropdown"}>
              ...
              <div className={"hdr-menu"}>
                ...
                <Link href={"/educational-cards"} className={"hdr-menu-link is-current"}>
                  Educational Cards
                </Link>
      ...
      <section className={"hero"}>
        <div className={"hero__bg"}>
          <img alt={"Educational Cards Manufacturer in India"} src={"/Educational-Cards/Educational-Cards-Banner.avif"} />
        ...
        <div className={"hero__content"}>
          ...
          <p className={"hero__text"}>
            Custom educational cards by A India Print House — high-quality, durable learning cards that make teaching interactive and learning fun for every age group.
          </p>
          <div>
        ...
        <div className={"container heritage__grid"}>
          ...
          <div className={"heritage__media"}>
            <div className={"media-frame tint-panel"} style={{ '--tint': "#f2f23c" }}>
              <img alt={"Custom Educational Learning Cards — A India Print House"} src={"/Educational-Cards/Educational-Cards1-fit.avif"} className={"no-parallax"} />
                ...
                <svg className={"badge__svg"} viewBox={"0 0 100 100"}>
                  ...
                  <text>
                    <textpath xlinkHref={"#textCirclePromo"}>
                      A INDIA PRINT HOUSE • EDUCATIONAL CARDS • SINCE 1998 •
                    </textpath>
                  </text>
                </svg>
        ...
        <div className={"container section--padded"}>
          <div className={"section-head"}>
            <h2 className={"headline-lg"} data-split="">
              High-Quality Educational Card Printing
            </h2>
            <div className={"section-head__rule"} data-scroll="" data-scroll-class={"is-inview"}></div>
            <p className={"body-lg section-head__text"}>
              We create educational cards with clear illustrations, vibrant colours, and professional finishing. Our team can customize every card with your curriculum, artwork, alphabets, numbers, images, and learning concepts — printed for maximum clarity and classroom durability.
            </p>
          </div>
                ...
                <div className={"atropos-rotate"}>
                  <div className={"atropos-inner"}>
                    <div className={"deck-card tint-panel"} style={{ '--tint': "#f2c43c" }}>
                      ...
                      <img alt={"Custom Curriculum Educational Cards — A India Print House"} src={"/Educational-Cards/Educational-Cards2-fit.avif"} className={"no-parallax"} />
                ...
                <div className={"atropos-rotate"}>
                  <div className={"atropos-inner"}>
                    <div className={"deck-card tint-panel"} style={{ '--tint': "#f2f23c" }}>
                      <div className={"deck-frame"} aria-hidden={"true"}></div>
                      <img alt={"Colourful Alphabet and Number Educational Cards — A India Print House"} src={"/Educational-Cards/Educational-Cards3-fit.avif"} className={"no-parallax"} />
                      <div className={"deck-card__caption"}>
                        <div>
                          <span className={"label-sm deck-card__kicker"}>
                            Vibrant Printing
                          ...
                          <h3 className={"headline-md deck-card__title"}>
                            Sharp, Colourful Learning Cards
                          </h3>
                        </div>
                      </div>
                    </div>
      ...
      <section className={"card-showcase"} id={"card-showcase"}>
        <div className={"card-showcase__content container section--padded"}>
          <span className={"eyebrow"}>
            Crafted for Every Classroom
          </span>
          <h2 className={"display-lg card-showcase__title"}>
            Cards That Make Learning Stick
          </h2>
          <p className={"card-showcase__text"}>
            From preschool alphabets to competitive-exam revision — every card is built for clarity, engagement, and lasting classroom use.
          </p>
        </div>
      </section>
      {/* Features Bento Grid */}
          ...
          <div className={"bento"}>
            ...
            <div className={"bento__cell bento__cell--feature"}>
              <div>
                ...
                <p className={"body-md bento__desc"}>
                  Crafted from thick, premium-grade card stock with rounded corners and non-toxic inks — built to handle little hands and survive countless learning sessions.
                </p>
              </div>
            ...
            <div className={"bento__cell"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Vivid colours and crisp, clear graphics that make letters, numbers, and images easy to recognise.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Bespoke artwork, alphabets, numbers, and curriculum concepts tailored to your syllabus.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Multiple card sizes and shapes to suit every age group, subject, and activity.
              </p>
            </div>
            <div className={"bento__cell"}>
              <span className={"material-symbols-outlined bento__icon"}>
              ...
              <p className={"bento__desc bento__desc--sm"}>
                Scalable production with customized boxed packaging for schools and publishers of any size.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={"section section--padded bg-dark"}>
        <div className={"container apps__grid"}>
          ...
          <div className={"apps__media tint-panel"} style={{ '--tint': "#3c69f2" }}>
            <img alt={"Educational Cards for Schools and Publishers — A India Print House"} src={"/Educational-Cards/Educational-Cards4-fit.avif"} className={"no-parallax"} />
      ...
      <section className={"section section--padded bg-surface"}>
        <div className={"container custom"}>
          <h2 className={"headline-lg custom__title"} data-split="">
            Benefits of Educational Cards
          </h2>
          <p className={"body-lg custom__quote"}>
            "Educational cards turn abstract lessons into something children can see, touch, and remember. They build vocabulary, sharpen memory, improve concentration, and make learning an active, joyful experience — both in the classroom and at home."
          </p>
        ...
        <div className={"container why__grid"}>
          <div className={"why__quote"}>
            <blockquote className={"headline-lg"}>
              "Creating Educational Cards That Make Every Lesson Memorable."
            </blockquote>
          </div>
            ...
            <div className={"why__benefits-grid"}>
              <div>
                ...
                <p className={"benefit__desc"}>
                  Content, illustrations, and text are matched to your syllabus and age group — printed and packaged as one ready-to-teach learning kit.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
              ...
              <div>
                ...
                <p className={"benefit__desc"}>
                  Reinforced card stock, rounded corners, and scratch-resistant coatings withstand daily handling — ideal for classrooms, activity kits, and retail sets.
                </p>
              </div>
              <div>
                <h6 className={"label-md benefit__title"} data-scroll="" data-scroll-class={"is-inview"}>
                  Sample-to-Bulk Production
                </h6>
                <p className={"benefit__desc"}>
                  Start with a small sample set to review quality, then scale to full print runs — our flexible MOQs support single schools and large publishers alike.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className={"section bg-dark cta"}>
        ...
        <div className={"container section--padded"}>
          <h2 className={"display-lg cta__title"}>
            Bring Your Educational Cards to Life
          </h2>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "18px", maxWidth: "640px", margin: "0 auto 48px", textAlign: "center", fontFamily: "var(--font-sans)" }}>
            Looking for a reliable Educational Cards Manufacturer in India? A India Print House offers customized educational card printing solutions with superior quality and engaging designs. A India Print House — Your Trusted Partner for Quality Learning Cards.
          </p>
        ...
        <div className={"footer-body container"}>
          <div className={"footer-top"}>
            <div className={"ft-brand-col"}>
              ...
              <p>
                India's trusted educational cards manufacturer — creating learning cards that make every lesson memorable.
              </p>
            </div>
