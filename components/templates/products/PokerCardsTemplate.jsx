/**
 * PokerCardsTemplate — the master /poker-cards markup, shared by the master
 * route and every /[location] route.
 *
 * Generated by scripts/build-templates.mjs from
 * .templates-src/poker-cards/page.jsx — edit that file, then re-run the
 * script. Hand edits here are overwritten.
 */
import Link from 'next/link';
import LegacyEngine from '@/components/LegacyEngine';
import '@/app/poker-cards/poker-cards.css';
...
export default function PokerCardsTemplate({ location = null }) {
  return (
    <div className="page-root">
          ...
          <nav className={"hdr-nav"}>
            ...
            <div className={"hdr-dropdown"}>
              ...
              <div className={"hdr-menu"}>
                ...
                <Link href={path("/poker-cards", location)} className={"hdr-menu-link is-current"}>
                  Poker Cards
                </Link>
      ...
      <LocationProductSections location={location} product={"poker-cards"} />
